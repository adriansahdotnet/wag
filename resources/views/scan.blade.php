                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="imageee text-center">
                                               ...
                                               {{-- text --}}
                                                ...
                                                <img src="{{asset('images/favicon.png')}}" height="200px" alt="">
                                                @else
                                                <img src="{{asset('images/favicon.png')}}" height="200px" alt="">
                                                @endif
                                            </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="widget-stats-large-info-container">
                                        <div class="card-header">
                                            <h5 class="card-title">Whatsapp Info<span class="badge badge-info badge-style-light">Lynch Store</span></h5>
                                        </div>
       ...
       socket.on('qrcode', ({token,data,message}) => {
        ...
        socket.on('connection-open',({token,user,ppUrl}) => {
            if(token == device ) {
                ...
                $('.number').html(`Number : ${token}`)
                $('.imageee').html(` <img src="${ppUrl}" height="200px" alt="">`)
